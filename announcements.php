...
<?php $get_id = $_GET['id']; ?>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									mysqli_query($connection, "INSERT INTO lecturer_class_announcements (lecturer_class_id,lecturer_id,content,date) values('$get_id','$session_id','$content',NOW())")or die(mysqli_error($connection));
									mysqli_query($connection, "INSERT INTO notification (lecturer_class_id,notification,date_of_notification,link) value('$get_id','Add Annoucements',NOW(),'announcements_student.php')")or die(mysqli_error($connection));
									?>
									<script>
				...
				<div class="span4 row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 <?php
								 $query_announcement = mysqli_query($connection, "SELECT * from lecturer_class_announcements
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("Your Post is Successfully Deleted", { header: 'Data Deleted' });
