...
mysqli_query($connection, "INSERT INTO lecturer_class_student (lecturer_class_student_id,lecturer_class_id,student_id,lecturer_id) values('$session_id','$subject_id','$class_id','admin/uploads/thumbnails.jpg','$school_year')")or die(mysqli_error($connection));
