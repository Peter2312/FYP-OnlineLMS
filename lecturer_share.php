...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('share_sidebar_lecturer.php'); ?>
                            ...
                            <div class="block-content collapse in">
								...
								<a data-toggle="modal" href="#backup_delete" id="delete"  class="btn btn-success" name=""><i class="icon-move icon-large"></i> Move</a>
									<?php include('modal_share_delete.php');  ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($connection, "SELECT * FROM lecturer_shared
										LEFT JOIN lecturer on lecturer_shared.lecturer_id = lecturer.lecturer_id
										WHERE shared_lecturer_id = '$session_id' 
										order by fdatein DESC")or die(mysqli_error($connection));
										while($row = mysqli_fetch_array($query)){
										$id  = $row['lecturer_shared_id'];
									?>                              
