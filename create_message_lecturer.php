<div class="span3" id="">
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a href="lecturer_message.php">For Lecturer</a>
										</li>
										<li class="active"><a href="lecturer_message_lecturer.php">For Student</a></li>
									</ul>
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="student_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($connection, "SELECT * from lecturer_class_student
																  LEFT JOIN student ON student.student_id = lecturer_class_student.student_id
											 group by lecturer_class_student.student_id order by firstname ASC");
			...
			jQuery("#send_message_student").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "send_message_lecturer_to_student.php",
						data: formData,
						success: function(html){
						
						$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'lecturer_message.php'  }, delay);  
