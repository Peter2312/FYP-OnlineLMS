...
if ($input_name == ""){
			...
			$name_notification  = 'Add Assignment file name'." ".'<b>'.$name.'</b>';
                ...
                mysqli_query($connection, "INSERT INTO assignment (fdesc,fdatein,lecturer_id,class_id,fname) VALUES ('$filedesc',NOW(),'$session_id','$id_class','$name')")or die(mysqli_error($connection));
