                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="lecturer_quiz.php" class="btn btn-success"><i class="icon-arrow-left"></i> Back</a>
									...
									<?php include('modal_delete_quiz_question.php'); ?>
                              		...
                              		<?php
										...
										where quiz_id = '$get_id'  order by date_added DESC ")or die(mysqli_error($connection));
