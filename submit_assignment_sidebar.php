	...
	<div class="row-fluid">
				      <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-plus-sign"></i> Assignment Submission</h4></div>
                            </div>
			...
			jQuery(document).ready(function($){
				$("#add_assignment").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "assign_save copy.php",
						data: formData,
						success: function(html){
							$.jGrowl("Student Successfully  Added", { header: 'Student Added' });
							window.location.href = 'submit_assignment.php<?php echo '?id='.$get_id.'&'.'post_id='.$post_id; ?>';
                            location.reload();
						},
