							...
							<!-- block -->
		                        <div class="block">
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Back</a>
									   <?php
									   $query = mysqli_query($connection, "SELECT * from content where content_id = '$get_id'")or die(mysqli_error($connection));
									   ...
									   <form class="form-horizontal" method="POST">
										...
										mysqli_query($connection, "UPDATE content set title = '$title' , content = '$content' where content_id = '$get_id'")or die(mysqli_error($connection));
										?>
										<script>
