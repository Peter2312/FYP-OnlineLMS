						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysqli_query($connection, "SELECT * from subject where subject_id = '$get_id'")or die(mysqli_error($connection));
									...
									?>
										...
										mysqli_query($connection, "UPDATE subject set subject_code = '$subject_code' ,
																		subject_title = '$title',
																		unit  = '$unit',
																		description = '$description'
																		where subject_id = '$get_id' ")or die(mysqli_error($connection));
																		
										mysqli_query($connection, "INSERT INTO activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')")or die(mysqli_error($connection));
