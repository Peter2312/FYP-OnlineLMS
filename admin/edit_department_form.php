   <div class="row-fluid">
    <a href="department.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Department</a>
                        ...
                        <div class="block">
							...
							<?php 
							$query = mysqli_query($connection, "SELECT * from department where department_id = '$get_id'")or die(mysqli_error($connection));
 ...
 mysqli_query($connection, "UPDATE department set department_name = '$dn' , dean  = '$d' where department_id = '$get_id' ")or die(mysqli_error($connection));
 ?>
 <script>
