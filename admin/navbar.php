  <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <span class="brand" href="#">ULTIMATE UNIVERSITY ONLINE LMS ADMIN</span>
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
						<?php $query= mysqli_query($connection, "SELECT * from users where user_id = '$session_id'")or die(mysqli_error($connection));
