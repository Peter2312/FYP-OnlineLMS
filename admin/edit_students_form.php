   <div class="row-fluid">
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($connection, "SELECT * from student LEFT JOIN class ON class.class_id = student.class_id where student_id = '$get_id'")or die(mysqli_error($connection));
								...
								<form method="post">
								        ...
								        <div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<?php
											$cys_query = mysqli_query($connection, "SELECT * from class order by class_name");
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($connection, "UPDATE student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' where student_id = '$get_id' ")or die(mysqli_error($connection));
