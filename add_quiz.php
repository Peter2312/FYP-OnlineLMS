                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="lecturer_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										mysqli_query($connection, "INSERT INTO quiz (quiz_title,quiz_description,date_added,lecturer_id) values('$quiz_title','$description',NOW(),'$session_id')")or die(mysqli_error($connection));
										?>
										<script>
