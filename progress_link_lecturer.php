<div class="span3" id="sidebar">
	<img id="avatar" src="admin/<?php echo $row['location']; ?>" class="img-polaroid">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				<li class=""><a href="dashboard_lecturer.php"><i class="icon-chevron-right"></i><i class="icon-chevron-left"></i>&nbsp;Back</a></li>
				...
				<li class=""><a href="discussion_board_lecturer.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-comment"></i>&nbsp;Discussion Board</a></li>
				<li class="active"><a href="view_progress.php<?php echo '?id='. $get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-bar-chart"></i>&nbsp;Student Progress</a></li>
			</ul>
