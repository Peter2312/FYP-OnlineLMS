...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('backpack_sidebar_lecturer.php'); ?>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query_backpack = mysqli_query($connection, "SELECT * FROM lecturer_backpack WHERE lecturer_id = '$session_id'  order by fdatein DESC ")or die(mysqli_error($connection));
								...
								?>
									...
									<?php include('modal_backpack_delete.php'); ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($connection, "SELECT * FROM lecturer_backpack WHERE lecturer_id = '$session_id'  order by fdatein DESC")or die(mysqli_error($connection));
