...
if (isset($_POST['add'])){
	...
	$query = mysqli_query($connection, "INSERT INTO event (date_end,date_start,event_title,lecturer_class_id) values('$date_end','$date_start','$title','$get_id')")or die(mysqli_error($connection));
	?>
	<script>
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
									...
									<?php $event_query = mysqli_query($connection, "SELECT * from event where lecturer_class_id = '$get_id' ")or die(mysqli_error($connection));
