                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                              		...
                              		<?php
										$query = mysqli_query($connection, "SELECT * FROM assignment where class_id = '$get_id' and lecturer_id = '$session_id' order by fdatein DESC ")or die(mysqli_error($connection));
