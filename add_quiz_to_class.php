...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="lecturer_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
									</div>
										...
										<div class="control-group">
											...
											<select name="quiz_id">
											<option></option>
												<?php  $query = mysqli_query($connection, "SELECT * from quiz where lecturer_id = '$session_id'")or die(mysqli_error($connection));
				...
				<tbody>
					<?php $query = mysqli_query($connection, "SELECT * from lecturer_class
										...
										where lecturer_id = '$session_id' and school_year = '$school_year' ")or die(mysqli_error($connection));
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											for($i=0; $i < $N; $i++)
											{
												mysqli_query($connection, "INSERT INTO class_quiz (lecturer_class_id,quiz_time,quiz_id) values('$id[$i]','$time','$quiz_id')")or die(mysqli_error($connection));
												mysqli_query($connection, "INSERT INTO notification (lecturer_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'student_quiz_list.php')")or die(mysqli_error($connection));
											} ?>
											<script>
