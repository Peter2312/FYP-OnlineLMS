			<form id="login_form1" class="form-signin" method="post">
						...
						<a href="forgot_password.php" class="forgot-password-link">
							<i class="icon-question-sign"></i> Forgot Password?
						</a>
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to ULTIMATE UNIVERSITY Learning Management System", { header: 'Login Success' });
									var delay = 1000;
			...
			New to ULTIMATE UNIVERSITY OLMS
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as lecturer" id="signin_lecturer" onclick="window.location='signup_lecturer.php'" name="login" class="btn btn-info" type="submit">I`m a lecturer</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
