                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									mysqli_query($connection, "UPDATE lecturer_class_announcements  set content = '$content' where lecturer_class_announcements_id = '$id' ")or die(mysqli_error($connection));
									?>
									<script>
