                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<?php 
								$my_student = mysqli_query($connection, "SELECT * FROM lecturer_class_student
														LEFT JOIN student ON student.student_id = lecturer_class_student.student_id 
														INNER JOIN class ON class.class_id = student.class_id where lecturer_class_id = '$get_id' order by lastname ")or die(mysqli_error($connection));
