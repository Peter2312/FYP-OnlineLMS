            ...
            <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<?php
										$query1 = mysqli_query($connection, "SELECT * FROM assignment where assignment_id = '$post_id'")or die(mysqli_error($connection));
										$row1 = mysqli_fetch_array($query1);
									
									?>
									<div class="alert alert-info">Submit Assignment in : <?php echo isset($row1['fname']) ? $row1['fname'] : ''; ?></div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										where assignment_id = '$post_id'  order by assignment_fdatein DESC")or die(mysqli_error($connection));
