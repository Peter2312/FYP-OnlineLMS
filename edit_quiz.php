                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysqli_query($connection, "SELECT * from quiz where quiz_id = '$get_id'")or die(mysqli_error($connection));
								...
								?>
										...
										mysqli_query($connection, "UPDATE quiz set quiz_title = '$quiz_title',quiz_description = '$description' where quiz_id = '$quiz_id'")or die(mysqli_error($connection));
										?>
										<script>
