...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('lecturer_message_sidebar.php'); ?>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="active">
										<a href="lecturer_message.php"><i class="icon-envelope-alt"></i>inbox</a>
										</li>
										<li class="">
									...
									<?php
								 $query_announcement = mysqli_query($connection, "SELECT * from message
																	LEFT JOIN lecturer ON lecturer.lecturer_id = message.sender_id
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('create_message_lecturer.php') ?>
            </div>
