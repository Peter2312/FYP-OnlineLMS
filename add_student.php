                        ...
                        <div id="block_bg" class="block">
						 ...
						 <thead>
                            ...
                            <tbody>
										...
										$a = 0 ;
										$query = mysqli_query($connection, "SELECT * from student LEFT JOIN class on class.class_id = student.class_id
...
if (isset($_POST['submit'])){
	...
	$Add = $_POST[$test4];
 	...
 	$query = mysqli_query($connection, "SELECT * from lecturer_class_student where student_id = '$id' and lecturer_class_id = '$class_id' ")or die(mysqli_error($connection));
	...
	mysqli_query($connection, "INSERT INTO lecturer_class_student (student_id,lecturer_class_id,lecturer_id) values('$id','$class_id','$lecturer_id') ")or die(mysqli_error($connection));
